...
//             longDescription: `
//               This e-commerce platform was built to provide a seamless shopping experience for users while giving store owners powerful management tools. The application includes features such as:
...
//               The frontend is built with React, using Redux for state management and styled-components for the UI. The backend uses Node.js with Express, and MongoDB for data storage. The application is fully responsive and optimized for all devices.
//             `,
//             category: 'web',
//             technologies: ['React', 'Node.js', 'MongoDB', 'Express', 'Redux', 'Stripe API', 'AWS S3'],
...
//               'https://images.unsplash.com/photo-1557821552-17105176677c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1674&q=80',
//               'https://images.unsplash.com/photo-1600267204091-5c1ab8b10c02?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1674&q=80'
//             ],
...
//         // await axios.put(`/api/projects/${id}`, dataToSubmit);
//         console.log('Updating project:', dataToSubmit);
//       } else {
//         // Create new project
